export function getSystemPrompt(dataSource, dataBase) {
  ...
  \`\`\`
  #23 Do not include the programming language at the start of the markdown code block
...
export function getUserPrompt(apiRoute, body, schema) {
  ...
  3. The updated data schema as a json object, with '!Updated schema!:' before it. If the fields of the body matches with the existing schema, do not modify the schema. If there is nothing provided, or if the collection name provided are all not appropriate, add a new collection on top of the existing schema based on the API route and request body
